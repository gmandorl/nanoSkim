...
p=PostProcessor(".",["root://cms-xrd-global.cern.ch//store/user/arizzi/nano80XDeepAndReg/SingleMuon/NanoDeepAndReg2016Run2016G-03Feb2017-v1/180516_082336/0000/test_data_80X_NANO_734.root"],"Jet_pt>20 && Muon_pt > 9 && Entry$ < 10000","keep_and_drop.txt",[exampleModuleDATA()],provenance=True)
...
#p=PostProcessor(".",["root://cms-xrd-global.cern.ch//store/user/arizzi/nano80XDeepAndReg/SingleMuon/NanoDeepAndReg2016Run2016G-03Feb2017-v1/180516_082336/0000/test_data_80X_NANO_734.root"],"Jet_pt>20 && Muon_pt > 9 && event==529282994","keep_and_drop.txt",[exampleModuleDATA()],provenance=True)
